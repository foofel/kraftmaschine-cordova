declare namespace BluetoothlePlugin {
    export interface Bluetoothle {
         ...
         * This can be very useful when the general state of the adapter has been lost, and we would otherwise need to go through 
         * a series of callbacks to get the correct state (first initialized, then enabled, then isScanning, and so forth). 
         ...
         * @param params                 Read descriptor's params
         */
        getAdapterInfo(result: (info: AdapterInfo) => void):void;
    }
